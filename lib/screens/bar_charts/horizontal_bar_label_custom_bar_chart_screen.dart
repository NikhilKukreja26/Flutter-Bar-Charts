...
class HorizontalBarLabelCustomBarChartScreen extends StatelessWidget {
  static List<charts.Series<OrdinalSalesModel, String>> createSampleData() {
    ...
    return [
      new charts.Series<OrdinalSalesModel, String>(
        ...
        insideLabelStyleAccessorFn: (OrdinalSalesModel sales, _) {
          final color = (sales.year == '2017')
        ...
        outsideLabelStyleAccessorFn: (OrdinalSalesModel sales, _) {
          final color = (sales.year == '2017')
              ? charts.MaterialPalette.red.shadeDefault
              : charts.MaterialPalette.yellow.shadeDefault.darker;
          return new charts.TextStyleSpec(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Horizontal Bar Label Custom Bar Chart'),
      ),
      body: Container(
