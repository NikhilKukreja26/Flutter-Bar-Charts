...
class RandomizedChartScreen extends StatefulWidget {
  @override
  _RandomizedChartScreenState createState() => _RandomizedChartScreenState();
}

class _RandomizedChartScreenState extends State<RandomizedChartScreen> {
